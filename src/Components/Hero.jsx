  ...
  return (
    <section className={`hero-section ${darkToggle ? 'hero-black' : ''}`}>
      ...
      <div className="hero-content">
        <h1 className="hero-h1  animate__animated animate__fadeInDown" style={darkToggle ? {color: 'white'} : {color: 'black'}}>Hola, soy {width > 768 ? <TypeWriterEffect text="Harlys Almanzar" speed={150} deleteSpeed={50} loop={true}/>: 'Harlys Almanzar'}</h1>
